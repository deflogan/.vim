...
if s:molokai_original == 1
   hi Normal          guifg=#000000 guibg=#272822
...
if &t_Co > 255
   ...
   hi Exception       ctermfg=151
   hi Float           ctermfg=135
   hi FoldColumn      ctermfg=67  ctermbg=16
   hi Folded          ctermfg=67  ctermbg=16
   hi Function        ctermfg=151
   ...
   " marks column
   hi SignColumn      ctermfg=151 ctermbg=235
   ...
   hi Typedef         ctermfg=139
   hi Type            ctermfg=139                cterm=none
   hi Underlined      ctermfg=167               cterm=underline
   ...
   if exists("g:rehash256") && g:rehash256 == 1
       ...
       hi Constant        ctermfg=58

       hi DiffDelete      ctermfg=125 ctermbg=233

       hi Directory       ctermfg=143
       hi Error           ctermfg=222 ctermbg=233
       hi Exception       ctermfg=143
       hi Float           ctermfg=141
       hi Function        ctermfg=65
       hi Identifier      ctermfg=137

       hi Keyword         ctermfg=110
       hi Operator        ctermfg=137
